...
//       randomImageIndex: this.shuffleRandomImage(),
//       isGameOver: false,
//       score: 0,
//       isTimerStop: false,
//     }
...
//     this.setState({
//       randomImageId: imagesList[randomImageIndex].id,
//     })
//   }

//   shuffleRandomImage = () => Math.floor(Math.random() * imagesList.length)
...
//     if (randomImageId === id) {
//       const newRandomImageIndex = this.shuffleRandomImage()
//       this.setState(prevState => ({
//         score: prevState.score + 1,
//         randomImageIndex: newRandomImageIndex,
//         randomImageId: imagesList[newRandomImageIndex].id,
//       }))
//     } else {
...
//     const filteredTabItems = this.getFilteredImages()
//     return (
...
//         />
//         {isGameOver ? (
//           <div className="gameOve-container">
...
class App extends Component {
  ...
  componentDidMount() {
    this.setRandomImageId()
  }

  componentDidUpdate(prevProps, prevState) {
    const {randomImageIndex} = this.state
    if (prevState.randomImageIndex !== randomImageIndex) {
      this.setRandomImageId()
    }
  }
  ...
  playAgain = () => {
    this.setState(
      ...
      () => {
        this.setState({resetTimer: false}) // Reset the resetTimer flag after handling
        this.setRandomImageId() // Set the new random image id
      },
    )
  }
